  ...
  return (
    <>
      <div className="bg-[#fcf5f4] w-full pt-16">
        {/* Login Texthead */}
        <div>
          <h1 className="text-center text-6xl font-bold italic">LOGIN</h1>
        </div>
        ...
        <div className="flex  w-full py-14 gap-0  ">
          <div className="w-2/4 flex  justify-center border-r-2 border-black gap-y-10  ">
            ...
            <div className="w-2/4 flex flex-col items-center  gap-6 ">
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <ForInput placeholder="Please Enter Your Username" />
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <div>
                ...
                <div>
                  <ForInput placeholder="Please Enter Your Password" />{" "}
                </div>
          ...
          <div className="w-2/4 flex   justify-center  border-r-1 border-black gap-y-10 ">
            <div className="w-full flex flex-col items-center justify-center  gap-4    ">
              ...
              <span>or</span>
              <Connect
                Link="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Facebook_Logo_%282019%29.png/1024px-Facebook_Logo_%282019%29.png"
